...
> Built key production tools for [Eyeline Studios'](https://eyelinestudios.com/en/studios/stages) virtual production stages, including LED volumes, volumetric capture, and the Light Dome.
